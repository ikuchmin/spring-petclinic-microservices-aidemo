...
helm.sh/chart: {{ include "customers-service.chart" . }}
...
*/}}
{{- define "customers-service.serviceAccountName" -}}
{{- if .Values.serviceAccount.create }}
{{- default (include "customers-service.fullname" .) .Values.serviceAccount.name }}
{{- else }}
